...
<html lang="de">
	<head>
		...
		<title>Latrinalia - Datenschutzerklärung</title>
	</head>
	<body>
		<div id="index">
			...
			<section id="maincontent">
				...
				<div class="small-11 small-centered medium-11 large-11 medium-centered large-centered columns">
					<div id="content" >
						...
						<p><h3 id="privacyFacebook" name="privacyFacebook">Datenschutzerklärung für die Nutzung von Facebook-Plugins (Like-Button)</h3></p> 
						...
						<p>Auf unseren Seiten sind Plugins des sozialen Netzwerks Facebook (Facebook Inc., 1601 Willow Road, Menlo Park, California, 94025, USA) integriert. Die Facebook-Plugins erkennen Sie an dem Facebook-Logo oder dem "Like-Button" ("Gefällt mir") auf unserer Seite. Eine Übersicht über die Facebook-Plugins finden Sie hier: <a href="http://developers.facebook.com/docs/plugins/" target="_blank">http://developers.facebook.com/docs/plugins/</a>.<br /> 
							...
							<p> </p>
							<p><h3 id="privacyGAnalytics" name="privacyAnalytics">Datenschutzerklärung für die Nutzung von Google Analytics</h3></p> 
							...
							<p><h3 id="privacyAdsense" name="privacyAdsense">Datenschutzerklärung für die Nutzung von Google Adsense</h3></p>
							...
							<p><h3 id="privacyGPlus" name="privacyGPlus">Datenschutzerklärung für die Nutzung von Google +1</h3></p> 

							<p><i>Erfassung und Weitergabe von Informationen:</i>
								<br /> 
								...
								<p><h3 id="privacyTwitter" name="privacyTwitter">Datenschutzerklärung für die Nutzung von Twitter</h3></p> 
